...
import MeetingMaximumUserField from '../components/FormComponents/MeetingMaximumUserField.tsx';
  ...
  const [createToast]=useToast()
   ...
   if(!validateForm()){
     ...
     await addDoc(meetingsRef,{
      ...
      meetingId,
      meetingName,
      meetingType:anyoneCanJoin ? "any-one-can-join":"video-conference",
      invitedUsers:anyoneCanJoin ? []
      :selectedUsers.map((users:UserType)=>users.uid),
