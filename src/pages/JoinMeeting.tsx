...
import { firebaseAuth, meetingsRef } from "../utils/FirebaseConfig.ts";
        ...
        if (fetchedMeetings.docs.length) {
          ...
          if (meeting.meetingType === "1-on-1") {
            ...
            const index = meeting.invitedUsers.findIndex(
              (invitedUsers: string) => invitedUsers === user?.uid
            );
...
const appId=611602917;
const serverSecret="fea966a098001488cded0c23b670daf9";
